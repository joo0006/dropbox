...
convenience of easy file management and sharing in one centralized solution.
</p>
...
<ArrowRight className="ml-10" />
        ...
        <div className="bg-black dark:bg-slate-800 h-full p-10">
...
Act 1976, allowance is made for "fair use" of this video for education purposes. 
    </p>
    </main>
  );
}
